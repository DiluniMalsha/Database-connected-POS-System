...
<form style="margin: 1%;width: 98%" id="customerForm" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputTelephone" placeholder="Telephone" name="customerTelephone">
        </div>
    </div>
</form>

<div style="margin-left: 80%" id="buttens">
    <button type="button" class="btn btn-outline-primary" id="btnSaveCustomer">Save</button>
...
<script>
    $("#btnSaveCustomer").click(
        function () {
            $("#customerForm").attr("action","save-cusomer.php");
            $("#customerForm").submit();
        }
    );
</script>
